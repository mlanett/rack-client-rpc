...
describe Rack::Client::Rpc::Parser do
  it "can substitute parameters into the url pattern" do
    Rack::Client::Rpc::Parser.substitute( "/foo/:id", ["id"], 1 ).must_equal "/foo/1"
    Rack::Client::Rpc::Parser.substitute( "/foo/:id/edit", ["id"], 1 ).must_equal "/foo/1/edit"
    Rack::Client::Rpc::Parser.substitute( "/bar/:pid/:id", ["pid","id"], 1, 2 ).must_equal "/bar/1/2"
  end
end

class WithParams < Rack::Client::Rpc::Client
